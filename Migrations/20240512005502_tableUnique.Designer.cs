...
namespace Restaurant_Project.Migrations
{
    ...
    [Migration("20240512005502_tableUnique")]
    partial class tableUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Restaurant_Project.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccessDate = new DateTime(2024, 5, 12, 3, 55, 2, 76, DateTimeKind.Local).AddTicks(3818),
                            DeliverState = true,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 12, 3, 25, 2, 76, DateTimeKind.Local).AddTicks(3763),
                            Price = 500.0,
                            TableId = 6,
                            Type = "VIP"
                        },
                        ...
                        {
                            Id = 2,
                            AccessDate = new DateTime(2024, 5, 12, 4, 55, 2, 76, DateTimeKind.Local).AddTicks(3824),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 4,
                            OrderDate = new DateTime(2024, 5, 12, 3, 55, 2, 76, DateTimeKind.Local).AddTicks(3823),
                            Price = 200.0,
                            TableId = 3,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 3,
                            AccessDate = new DateTime(2024, 5, 12, 4, 40, 2, 76, DateTimeKind.Local).AddTicks(3828),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 3,
                            OrderDate = new DateTime(2024, 5, 12, 3, 55, 2, 76, DateTimeKind.Local).AddTicks(3827),
                            Price = 350.0,
                            TableId = 2,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 4,
                            AccessDate = new DateTime(2024, 5, 12, 4, 25, 2, 76, DateTimeKind.Local).AddTicks(3831),
                            DeliverState = false,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 12, 3, 55, 2, 76, DateTimeKind.Local).AddTicks(3830),
                            Price = 400.0,
                            TableId = 6,
                            Type = "VIP"
                        });
