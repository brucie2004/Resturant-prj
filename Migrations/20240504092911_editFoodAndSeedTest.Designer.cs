...
namespace Restaurant_Project.Migrations
{
    ...
    [Migration("20240504092911_editFoodAndSeedTest")]
    partial class editFoodAndSeedTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Restaurant_Project.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccessDate = new DateTime(2024, 5, 4, 12, 29, 11, 661, DateTimeKind.Local).AddTicks(1971),
                            DeliverState = true,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 4, 11, 59, 11, 661, DateTimeKind.Local).AddTicks(1920),
                            Price = 500.0,
                            TableId = 6,
                            Type = "VIP"
                        },
                        ...
                        {
                            Id = 2,
                            AccessDate = new DateTime(2024, 5, 4, 13, 29, 11, 661, DateTimeKind.Local).AddTicks(1977),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 4,
                            OrderDate = new DateTime(2024, 5, 4, 12, 29, 11, 661, DateTimeKind.Local).AddTicks(1976),
                            Price = 200.0,
                            TableId = 3,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 3,
                            AccessDate = new DateTime(2024, 5, 4, 13, 14, 11, 661, DateTimeKind.Local).AddTicks(1980),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 3,
                            OrderDate = new DateTime(2024, 5, 4, 12, 29, 11, 661, DateTimeKind.Local).AddTicks(1979),
                            Price = 350.0,
                            TableId = 2,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 4,
                            AccessDate = new DateTime(2024, 5, 4, 12, 59, 11, 661, DateTimeKind.Local).AddTicks(1983),
                            DeliverState = false,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 4, 12, 29, 11, 661, DateTimeKind.Local).AddTicks(1982),
                            Price = 400.0,
                            TableId = 6,
                            Type = "VIP"
                        });
