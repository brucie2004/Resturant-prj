...
namespace Restaurant_Project.Migrations
{
    ...
    [Migration("20240512063731_returningManually")]
    partial class returningManually
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Restaurant_Project.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccessDate = new DateTime(2024, 5, 12, 9, 37, 30, 896, DateTimeKind.Local).AddTicks(235),
                            DeliverState = true,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 12, 9, 7, 30, 896, DateTimeKind.Local).AddTicks(184),
                            Price = 500.0,
                            TableId = 6,
                            Type = "VIP"
                        },
                        ...
                        {
                            Id = 2,
                            AccessDate = new DateTime(2024, 5, 12, 10, 37, 30, 896, DateTimeKind.Local).AddTicks(241),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 4,
                            OrderDate = new DateTime(2024, 5, 12, 9, 37, 30, 896, DateTimeKind.Local).AddTicks(240),
                            Price = 200.0,
                            TableId = 3,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 3,
                            AccessDate = new DateTime(2024, 5, 12, 10, 22, 30, 896, DateTimeKind.Local).AddTicks(245),
                            DeliverState = false,
                            DeliveryEmployer = 2,
                            NumberOfItems = 3,
                            OrderDate = new DateTime(2024, 5, 12, 9, 37, 30, 896, DateTimeKind.Local).AddTicks(244),
                            Price = 350.0,
                            TableId = 2,
                            Type = "ordinary"
                        },
                        ...
                        {
                            Id = 4,
                            AccessDate = new DateTime(2024, 5, 12, 10, 7, 30, 896, DateTimeKind.Local).AddTicks(248),
                            DeliverState = false,
                            DeliveryEmployer = 1,
                            NumberOfItems = 2,
                            OrderDate = new DateTime(2024, 5, 12, 9, 37, 30, 896, DateTimeKind.Local).AddTicks(247),
                            Price = 400.0,
                            TableId = 6,
                            Type = "VIP"
                        });
